...
func (c *chatServiceClient) JoinChannel(ctx context.Context, in *Channel, opts ...grpc.CallOption) (ChatService_JoinChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/v1.ChatService/JoinChannel", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatServiceClient) SendMessage(ctx context.Context, opts ...grpc.CallOption) (ChatService_SendMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[1], "/v1.ChatService/SendMessage", opts...)
	if err != nil {
		return nil, err
	}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "backend/api/proto/v1/chat.proto",
}
